...
const ViewPendingJobs = () => {
  ...
  const getJobs = () => {
    axios({
      method: "GET",
      url: "http://localhost:3001/getpendingjobs",
    })
      .then((response) => {
  ...
  const deleteJob = (index) => {
    axios({
      method: "POST",
      url: "http://localhost:3001/deletejobs",
      data: {
        job_id: index,
      },
    })
  ...
  const handleSubmit = (e) => {
    ...
    axios({
      method: "PUT",
      url: "http://localhost:3001/editjobs",
      data: job,
    })
      .then((response) => {
        setShow(false);
  ...
  return (
    <>
      <header className="header">You are viewing the pending jobs!</header>
      ...
      <Modal show={show} onHide={() => setShow(false)}>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label htmlFor="salaryAmt">Salary</label>
              <input
                className="form-control"
                id="salary"
        ...
        <Modal.Footer>
          <Alert variant="danger">success/failure</Alert>
        </Modal.Footer>
      </Modal>
    </>
  );
